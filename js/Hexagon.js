...
var Hexagon = function(args) {
    ...
    if (!(args.hasOwnProperty('type'))) {
      debugger;
      throw {
        message: 'Недостаток аргументов type.'
      };
    }
    this.x = args.x;
    this.y = args.y;
...
Hexagon.prototype.lightAnimationDuration = 600;
Hexagon.prototype.lightAnimationAtSameTime = 2;
...
Hexagon.prototype.lightAnimationDone = function(H) {
  ...
  return function() {
    ...
    H.animate({
      ...
      duration: this.lightAnimationDuration / 2,
      step: animationStep,
      done: animationDone
    })
  }
